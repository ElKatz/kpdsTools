function c = eyelinkSetup(c)
% c = eyelinkSetup(c)
% setup an 'el' struct withing the 'c' struct in order to enable
% krauzlis pldaps to use the Eyelink toolbox.
% this function should be called from the *_settings.m file.
